...
const TandI: React.FC = () => {
  return (
    <div>
      <div className='flex flex-col-reverse lg:flex-row space-x-28 m-8'>
        {/* Image */}
      <div className='flex justify-center'>
      <div className='w-80 h-80 mt-20 bg-blue-100 shadow-xl rounded-full'>
        <Image />
      </div>
      </div>
      {/* Text */}
      ...
      {/* First Button */}
      <div className='hidden lg:block lg:ml-28 my-8'>
